 ...
 if(!location.pathname.includes('/admin/')){
   ...
   if(document.body && location.pathname.endsWith('ai-lab.html')){
     ...
     if(!document.querySelector('[data-nn-tutorial-banner]')){
       const hero=document.querySelector('.page-hero');if(hero){const section=document.createElement('section');section.setAttribute('data-nn-tutorial-banner','');section.innerHTML=`<div class="container"><div class="card" style="margin:24px 0;padding:22px;display:flex;gap:22px;align-items:center;justify-content:space-between;flex-wrap:wrap"><div><div class="kicker">BADM-201 · Guided chapter labs</div><h2 style="margin:.25rem 0">From Neural Features to Language Decisions</h2><p style="margin:0;max-width:780px">Operate Chapter 2 CNN stages, compare Chapter 3 vision tasks, and test Chapter 4 language context and memory with evidence-ready reports.</p></div><div><a class="btn primary" href="neural-network-lab.html">Chapter 2 →</a> <a class="btn" href="chapter-3-machine-vision-lab.html">Chapter 3 →</a> <a class="btn" href="chapter-4-nlp-lab.html">Chapter 4 →</a></div></div></div>`;hero.insertAdjacentElement('afterend',section);}
     }
   }
   if(document.body && location.pathname.endsWith('neural-network-tutorial.html')){
     ...
     addStyle('assets/css/neural-enhancements.css?v=20260828e','data-nn-enhancements');
     addStyle('assets/css/neural-coherence-v3.css?v=20260828e','data-nn-coherence');
     addScript('assets/js/neural-enhancements.js?v=20260828e','data-nn-enhancements');
     addScript('assets/js/neural-assignment.js?v=20260828e','data-nn-assignment');
     addScript('assets/js/neural-evidence.js?v=20260828e','data-nn-evidence');
     addScript('assets/js/neural-layout-hotfix-v4.js?v=20260828e','data-nn-layout-hotfix');
   }
 }
})();
